...
export default function Home() {
  return (
    <div className="h-[calc(100vh-53px)] w-screen flex bg-[#0a0a0f]">
      {/* Left panel — Upload */}
      <div className="w-[30vw] h-full flex flex-col border-r border-zinc-800/60 relative">
      ...
      {/* Right panel — Chat */}
      <div className="w-[70vw] h-full flex flex-col relative">
        {/* Top accent line */}
